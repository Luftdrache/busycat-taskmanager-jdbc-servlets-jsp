...
<%--   <form action="tasks/new_task" method="post">--%>
<%--        <p><input type="submit" onclick="setVisible()" value="New Task" class="submitButtonNewTask"></p>--%>
<%--   </form>--%>
<%--    <form action="tasks/new_goal" method="post">--%>
<%--        <p><input type="submit" value="New Goal" class="submitButtonNewTask"></p>--%>
<%--    </form>--%>
</div>
